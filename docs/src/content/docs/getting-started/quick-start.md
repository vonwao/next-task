...
Let's create a simple project using next-task to coordinate AI agents.
...
- Executes with assigned agent
- Commits and marks done
...
- [Task Files](/concepts/task-files/) — Learn the TASKS.md format
- [Agents](/concepts/agents/) — Configure Codex vs Claude
- [Loop Mode](/concepts/loop-mode/) — Ralph-style continuous execution
- [Commands Reference](/commands/run/) — Full CLI documentation
